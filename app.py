...
# load the model 
model_RFC = jb.load('model_RFC.pkl')
...
if selected_option == 'Prediction':
    ...
    def prediction(Sym_1,Sym_2,Sym_3,Sym_4,Sym_5,Sym_6,Sym_7,Sym_8,Sym_9,Sym_10,Sym_11,Sym_12,Sym_13,Sym_14,Sym_15,Sym_16,Sym_17):
        ...
        severity = pd.read_csv(r"C:\Users\priya\Downloads\ML Project\Symptom-severity.csv")
...
# Add Data page  
    ...
    def add_data(label,Sym_1,Sym_2,Sym_3,Sym_4,Sym_5,Sym_6,Sym_7,Sym_8,Sym_9,Sym_10,Sym_11,Sym_12,Sym_13,Sym_14,Sym_15,Sym_16,Sym_17):
        ...
        dataset = pd.read_csv(r"C:\Users\priya\Downloads\ML Project\dataset.csv")
        ...
        dataset.to_csv(r"C:\Users\priya\Downloads\ML Project\dataset.csv",mode = 'w', index= False)
        
        # dataset new data  
        df = pd.read_csv(r"C:\Users\priya\Downloads\ML Project\dataset.csv")
